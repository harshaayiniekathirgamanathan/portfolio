...
import { Mail, Download, Send, Sparkles, MessageSquare } from 'lucide-react';
        ...
        <div className="relative rounded-3xl bg-gradient-to-br from-[#111827] via-slate-900 to-cyan-950/60 border border-cyan-500/30 p-8 sm:p-12 shadow-2xl overflow-hidden text-center">
          ...
          <div className="relative z-10 space-y-6 max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-100 tracking-tight">
              Let's Build Something <span className="text-gradient">With Data</span>
            </h2>
            ...
            <div className="pt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              >
                ...
                <span className="text-[11px] text-cyan-300 font-mono px-2 py-0.5 rounded bg-cyan-950 border border-cyan-800/60 truncate max-w-full">
